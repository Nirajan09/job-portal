...
const Header = ({ User, profileInfo }) => {
  ...
  return (
    <header className="flex justify-between h-[12vh] w-full items-center shrink-0 p-6 lg:p-8 border-b-2">
      {/* Logo */}
      <Link
        className="lg:text-size-4xl md:text-size-3xl text-size-2xl font-bold text-3xl mr-6 -text--clr-slate800"
        href="/"
      >
        JobVista.
      </Link>
      ...
      <Sheet>
        ...
        <SheetContent side="right">
          <Link href="#" className="mr-6">
            <h3 className="lg:text-size-[100px] md:text-size-3xl text-size-2xl -text--clr-slate800">
              JobVista.
            </h3>
          </Link>
